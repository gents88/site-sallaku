  ...
  template: `
    <div class="tool-page">
      <div class="tool-hero">
        ...
        <h1>Convert</h1>
        <p>Convert documents between PDF, Word, Excel, PowerPoint, images, and more.</p>
...
export class ConvertComponent {
  readonly features = [
    { icon: '📄→📘', title: 'PDF to Word',    desc: 'Convert PDF to editable .docx preserving styles.' },
    { icon: '📘→📄', title: 'Word to PDF',    desc: 'High-fidelity Word document to PDF conversion.' },
    { icon: '📊→📄', title: 'Excel to PDF',   desc: 'Convert spreadsheets with grid, charts, and data intact.' },
    { icon: '🖼→📄',  title: 'Image to PDF',  desc: 'Merge JPG, PNG, TIFF images into a single PDF.' },
    { icon: '📄→🖼',  title: 'PDF to Image',  desc: 'Export each page as high-res PNG or JPG.' },
    { icon: '📧→📄', title: 'Email to PDF',   desc: 'Convert .eml or .msg email threads to PDF.' },
  ];
}
