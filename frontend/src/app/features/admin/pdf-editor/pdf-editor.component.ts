  ...
  template: `
    <div class="tool-page">
      <div class="tool-hero">
        ...
        <h1>PDF Editor</h1>
        <p>Edit text, images, and annotations directly inside any PDF document.</p>
...
export class PdfEditorComponent {
  readonly features = [
    { icon: '✏️', title: 'Text Editing',   desc: 'Edit any text block inside your PDF directly.' },
    { icon: '🖼️', title: 'Image Replace',  desc: 'Swap images without affecting surrounding layout.' },
    { icon: '📝', title: 'Annotations',    desc: 'Add highlights, comments, and sticky notes.' },
    { icon: '🔏', title: 'Digital Sign',   desc: 'Apply legally binding electronic signatures.' },
    { icon: '🎨', title: 'Redaction',      desc: 'Permanently hide sensitive information.' },
    { icon: '📏', title: 'Page Resize',    desc: 'Crop, rotate, or resize individual pages.' },
  ];
}
