  ...
  template: `
    <div class="tool-page">
      <div class="tool-hero">
        ...
        <h1>OCR</h1>
        <p>Extract text from scanned PDFs, images, and photos using AI-powered optical character recognition.</p>
...
export class OcrComponent {
  readonly features = [
    { icon: '📷', title: 'Multi-Language',  desc: 'Recognise text in 100+ languages with high accuracy.' },
    { icon: '📐', title: 'Layout Aware',    desc: 'Preserves tables, columns, and multi-block structures.' },
    { icon: '🖼️', title: 'Image Input',    desc: 'Accepts JPG, PNG, TIFF, WEBP, and BMP files.' },
    { icon: '📄', title: 'Scanned PDFs',    desc: 'Automatically detects and extracts text from scanned PDFs.' },
    { icon: '🔍', title: 'Handwriting',     desc: 'Experimental support for handwritten document OCR.' },
    { icon: '📤', title: 'Text Export',     desc: 'Export recognised text as plain TXT, JSON, or searchable PDF.' },
  ];
}
